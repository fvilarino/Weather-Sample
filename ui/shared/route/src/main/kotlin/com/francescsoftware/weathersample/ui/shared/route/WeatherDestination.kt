...
object WeatherDestination : NavigationDestination {
    /** @{inheritDoc} */
    override val titleId: Int = com.francescsoftware.weathersample.ui.shared.assets.R.string.weather_label

    /** @{inheritDoc} */
    override val iconId: Int = com.francescsoftware.weathersample.ui.shared.assets.R.drawable.ic_arrow_back

    /** @{inheritDoc} */
    override val iconContentDescriptionId: Int =
        com.francescsoftware.weathersample.ui.shared.assets.R.string.content_description_back
